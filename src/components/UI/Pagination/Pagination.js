...
export const Pagination = ({ setCurrentPage, currentPage, totalPages }) => {
    ...
    return (
        <div className={styles.pagination}>
            <ul>
                <li className={currentPage === 1 ? styles.active : ''} onClick={() => setCurrentPage(currentPage > 1 ? currentPage - 1 : 1)}>⟽</li>
                ...
                <li className={currentPage === totalPages ? styles.active : ''} onClick={() => setCurrentPage(currentPage < totalPages ? currentPage + 1 : totalPages)}>⟾</li>
            </ul>
        </div>)
}